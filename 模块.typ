...
#let 不对称生殖流程图 = {
  ...
  diagram(
    ...
    node((4, -1), [*#元素[不对称结婚]*\ ♂×#元素[嗜血仙子]], fill: rgb("#e8daef")),
    edge((4, -1), (5, -1), "->", label: text(fill: p)[卵细胞+极体]),
    node((5, -1), [*#元素[嗜血仙子]*\ 三倍体], fill: rgb("#e8daef")),
    edge((4, -1), (5, -2), "->", label: text(fill: b)[精子(单倍体)]),
    node((5, -2), [*精子*\ 雄性#元素[怪动植物]], fill: rgb("#dce6f0")),
    edge((5, -2), (5, -3), "->", label: text(fill: p)[单倍体]),
    node((5, -3), [*配子形成*\ 卵巢内降解怪物染色体], fill: rgb("#e8daef")),
    edge((5, -1), (6, -1), "->", label: text(fill: p)[卵+极体+精子]),
    node((6, -1), [*受精卵*\ 三倍体], fill: rgb("#fde2e4")),
